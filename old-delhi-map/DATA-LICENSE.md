...
The bundled OpenLayers library is distributed under the BSD 2-Clause License. Its full licence is in `vendor/OPENLAYERS-LICENSE.md`.

The 1858 *Illustrated London News* engraving is in the public domain. Detailed source and transformation provenance is maintained in the source project's `PROVENANCE.md`.
